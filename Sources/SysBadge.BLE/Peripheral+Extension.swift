...
public extension Peripheral {
    func readValue<Value>(forDISCharacteristic: Services.DeviceInformationService) async throws -> Value? where Value: PeripheralDataConvertible {
        try await readValue(forCharacteristicWithCBUUID: forDISCharacteristic.rawValue, ofServiceWithCBUUID: Services.deviceInformationService.rawValue)
    }
    ...
    func readValue<Value>(forSysBadgeCharacteristic: Services.SysBadgeService) async throws -> Value? where Value: PeripheralDataConvertible {
        try await readValue(forCharacteristicWithCBUUID: forSysBadgeCharacteristic.rawValue, ofServiceWithCBUUID: Services.sysBadgeService.rawValue)
    }
}
